# -*- coding: utf-8 -*-
"""
Created on Mon Oct 16 07:28:02 2023
...
diabetes_model = pickle.load(open('C:/Users/Nihcas/Documents/Multiple disease prediction/Multiple_disease/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('C:/Users/Nihcas/Documents/Multiple disease prediction/Multiple_disease/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('C:/Users/Nihcas/Documents/Multiple disease prediction/Multiple_disease/parkinsons_model.sav', 'rb'))

breast_cancer_model = pickle.load(open('C:/Users/Nihcas/Documents/Multiple disease prediction/Multiple_disease/breast_cancer_model.sav', 'rb'))

lung_cancer_model = pickle.load(open('C:/Users/Nihcas/Documents/Multiple disease prediction/Multiple_disease/lung_cancer_model.sav', 'rb'))
...
# getting the input data from the user
    ...
    if st.button("Breast Cancer Test Result"):
        breast_cancer_prediction = breast_cancer_model.predict([[id, radius_mean, texture_mean, perimeter_mean, area_mean, smoothness_mean, compactness_mean, concavity_mean, concave_points_mean, symmetry_mean, fractal_dimension_mean, radius_se, texture_se, perimeter_se, area_se, smoothness_se, compactness_se, concavity_se, concave_points_se, symmetry_se, fractal_dimension_se, radius_worst, texture_worst, perimeter_worst, area_worst, smoothness_worst, compactness_worst, concavity_worst, concave_points_worst, symmetry_worst, fractal_dimension_worst]])                          
